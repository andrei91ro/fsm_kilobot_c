...
#define SLEEP_MS_BETWEEN_SIMSTEPS 10 //the number of miliseconds to wait before executing the next Lulu simulation step
...
/**
 * @brief Default finite state machine event handler - does not change anything
 */
void handle_default();
